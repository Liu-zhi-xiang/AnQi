...
import com.motorbike.anqi.core.util.QRSpotHelper;
...
public class CaptureActivity extends Activity implements DecoratedBarcodeView.TorchListener {
    ...
    private void initView()
    {
        ...
        mSwitchLightView = (ImageView) findViewById(R.id.btn_switch_light);
        mOpenAlbumView = (TextView) findViewById(R.id.btn_open_album);
