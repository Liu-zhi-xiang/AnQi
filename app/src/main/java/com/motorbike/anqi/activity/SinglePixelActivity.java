package com.motorbike.anqi.activity;
...
import com.motorbike.anqi.util.Contants;
import com.motorbike.anqi.util.ScreenManager;
import com.motorbike.anqi.util.SystemUtils;
...
public class SinglePixelActivity extends AppCompatActivity {
    ...
    protected void onDestroy() {
        ...
        if(! SystemUtils.isAPPALive(this,Contants.PACKAGE_NAME)){
            Intent intentAlive = new Intent(this, MainActivityTwo.class);
