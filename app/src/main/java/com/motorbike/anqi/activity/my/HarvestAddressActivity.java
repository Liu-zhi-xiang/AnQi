...
public class HarvestAddressActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void http(String userId,String receiver,String phone,String addressDetail,String address,String isdefault){
        showLoading();
        addMap=new HashMap<>();
        if (addMap!=null){
            addMap.clear();
        ...
        okHttp(this, BaseRequesUrl.AddAddress, HttpTagUtil.AddAddress,addMap);
                    ...
                    if (!TextUtils.isEmpty(phone)){
                        if (!TextUtils.isEmpty(tx)){
                            if (!TextUtils.isEmpty(addDetail)){
                                http(preference.getUserId(),name,phone,addDetail,tx,moren);
                            }else {
                                showTip("详细地址不能为空");
                            }
                        }else {
